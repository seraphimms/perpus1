    ...
    <div class="glass" style="border-radius:16px;padding:28px;">
        <form action="{{ route('buku.update', $buku) }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                ...
                <div>
                    <label style="display:block;color:rgba(255,255,255,0.70);font-size:13px;font-weight:500;margin-bottom:7px;">Tahun Terbit</label>
                    <input type="number" name="tahun" value="{{ old('tahun', $buku->tahun) }}" min="1900" max="{{ date('Y') + 1 }}"
                           class="glass-input" style="width:100%;border-radius:10px;padding:10px 14px;font-size:13.5px;box-sizing:border-box;">
                ...
                <div>
                    <label style="display:block;color:rgba(255,255,255,0.70);font-size:13px;font-weight:500;margin-bottom:7px;">Jumlah Stok</label>
                    <input type="number" name="jumlah" value="{{ old('jumlah', $buku->jumlah) }}" min="0"
                           class="glass-input" style="width:100%;border-radius:10px;padding:10px 14px;font-size:13.5px;box-sizing:border-box;">
                    @error('jumlah')<p style="margin-top:5px;font-size:12px;color:#fca5a5;">{{ $message }}</p>@enderror
                </div>

                <div style="grid-column:1/-1;">
                    <label style="display:block;color:rgba(255,255,255,0.70);font-size:13px;font-weight:500;margin-bottom:7px;">Kategori</label>
                ...
                <div style="grid-column:1/-1;">
                    ...
                    @if($buku->cover)
                    <div style="margin-bottom:12px;display:flex;align-items:center;gap:14px;background:rgba(255,255,255,0.05);border-radius:10px;padding:12px;">
                        ...
                        <div>
                            <p style="color:rgba(255,255,255,0.70);font-size:13px;font-weight:500;">Cover saat ini</p>
                            <p style="color:rgba(255,255,255,0.35);font-size:12px;margin-top:2px;">Upload baru di bawah untuk mengganti</p>
                        </div>
                    </div>
                    @endif
                    <label for="cover" id="coverLabel"
                           style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;border:2px dashed rgba(255,255,255,0.15);border-radius:12px;padding:24px;cursor:pointer;transition:border-color 0.2s;"
                        ...
                        <div style="text-align:center;">
                            <p style="color:rgba(255,255,255,0.70);font-size:13px;font-weight:500;">
                    ...
                    {{-- Preview cover baru --}}
                    <div id="coverPreviewWrap" style="display:none;margin-top:10px;text-align:center;">
                        <p style="color:rgba(255,255,255,0.40);font-size:12px;margin-bottom:6px;">Preview cover baru:</p>
                ...
                <div style="grid-column:1/-1;">
                    ...
                    <textarea name="deskripsi" rows="4"
                              class="glass-input" style="width:100%;border-radius:10px;padding:10px 14px;font-size:13.5px;box-sizing:border-box;resize:vertical;">{{ old('deskripsi', $buku->deskripsi) }}</textarea>
