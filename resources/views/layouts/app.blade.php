...
<div class="flex h-screen overflow-hidden" style="position:relative;z-index:1;">
    ...
    <aside id="main-sidebar">
        ...
        <div style="padding:20px;display:flex;align-items:center;gap:12px;border-bottom:1px solid rgba(255,255,255,0.07);flex-shrink:0;">
            ...
            <button id="sidebar-close-btn" onclick="closeSidebar()" aria-label="Tutup">
        ...
        <nav style="flex:1;overflow-y:auto;padding:7px 10px;">
            ...
            <a href="{{ route('buku.index') }}" onclick="closeSidebar()"
            ...
            <a href="{{ route('member.riwayat') }}" onclick="closeSidebar()"
            ...
            @if(auth()->user()->isAdmin())
            <a href="{{ route('kategori.index') }}" onclick="closeSidebar()"
            ...
            <a href="{{ route('pinjam.index') }}" onclick="closeSidebar()"
               class="nav-link {{ request()->routeIs('pinjam.*') ? 'active' : '' }}">
                <svg style="width:17px;height:17px;flex-shrink:0;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                Peminjaman
            </a>

            <a href="{{ route('pengembalian.index') }}" onclick="closeSidebar()"
            ...
            <a href="{{ route('laporan.pinjam') }}" onclick="closeSidebar()"
            ...
            <a href="{{ route('laporan.pengembalian') }}" onclick="closeSidebar()"
            ...
            <a href="{{ route('profil.index') }}" onclick="closeSidebar()"
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header id="topbar" class="glass-dark flex items-center justify-between flex-shrink-0"
            ...
            <div style="display:flex;align-items:center;gap:12px;">
                <button id="hamburger-btn" onclick="openSidebar()" aria-label="Menu">
            ...
            <div style="display:flex;align-items:center;gap:12px;">
                ...
                <div style="position:relative;">
                    ...
                    <div id="notifDropdown"
                         style="display:none;position:absolute;right:0;top:44px;width:340px;max-width:calc(100vw - 32px);background:#1e2a45;border:1px solid rgba(255,255,255,0.10);border-radius:14px;overflow:hidden;z-index:200;">
