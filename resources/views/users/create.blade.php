            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                ...
                <div style="grid-column:1/-1;">
                    ...
                    <textarea name="alamat" rows="2"
                              class="glass-input" style="width:100%;border-radius:10px;padding:10px 14px;font-size:13.5px;box-sizing:border-box;resize:vertical;">{{ old('alamat') }}</textarea>
                </div>
                ...
                <div>
                    <label style="display:block;color:rgba(255,255,255,0.70);font-size:13px;font-weight:500;margin-bottom:7px;">Role <span style="color:#f87171;">*</span></label>
                    <select name="jenis" class="glass-select" style="width:100%;border-radius:10px;padding:10px 14px;font-size:13.5px;box-sizing:border-box;">
                        <option value="member" {{ old('jenis')==='member' ? 'selected' : '' }}>Member</option>
                ...
                <div>
                    <label style="display:block;color:rgba(255,255,255,0.70);font-size:13px;font-weight:500;margin-bottom:7px;">Password <span style="color:#f87171;">*</span></label>
                ...
                <div>
                    <label style="display:block;color:rgba(255,255,255,0.70);font-size:13px;font-weight:500;margin-bottom:7px;">Konfirmasi Password <span style="color:#f87171;">*</span></label>
