        ...
        <form action="{{ route('kategori.update', $kategori) }}" method="POST">
            ...
            <div style="margin-bottom:24px;">
                ...
                <textarea name="deskripsi" rows="3"
                          class="glass-input" style="width:100%;border-radius:10px;padding:10px 14px;font-size:13.5px;box-sizing:border-box;resize:vertical;">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
            </div>
